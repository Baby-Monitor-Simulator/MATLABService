classdef (Hidden) VISAUnclassifiedAttribute < uint32
% UNCLASSIFIEDATTRIBUTE - enumeration class that defines most of the
% possible attributes provided by VISA (these values are obtained from
% attributes listed in visa.h)
%
...
% Copyright 2020 The MathWorks, Inc.
    ...
    methods
        function type = getAttributeType(attribute)
            % Determine type of attribute (presumed to be uint32 unless it
            % is a string)
            switch attribute
                case {...
                      visalib.internal.VISAUnclassifiedAttribute.VI_ATTR_INTF_INST_NAME,...
                      visalib.internal.VISAUnclassifiedAttribute.VI_ATTR_RSRC_MANF_NAME,...
                      visalib.internal.VISAUnclassifiedAttribute.VI_ATTR_RSRC_CLASS,...
                      visalib.internal.VISAUnclassifiedAttribute.VI_ATTR_OPER_NAME,...
                      visalib.internal.VISAUnclassifiedAttribute.VI_ATTR_MANF_NAME,...
                      visalib.internal.VISAUnclassifiedAttribute.VI_ATTR_MODEL_NAME,...
                      visalib.internal.VISAUnclassifiedAttribute.VI_ATTR_USB_SERIAL_NUM,...
                      visalib.internal.VISAUnclassifiedAttribute.VI_ATTR_PXI_SLOTPATH,...
                      visalib.internal.VISAUnclassifiedAttribute.VI_ATTR_TCPIP_ADDR,...
                      visalib.internal.VISAUnclassifiedAttribute.VI_ATTR_TCPIP_HOSTNAME,...
                      visalib.internal.VISAUnclassifiedAttribute.VI_ATTR_TCPIP_DEVICE_NAME...
                     }
                    type = "string";
                case visalib.internal.VISAUnclassifiedAttribute.VI_ATTR_USER_DATA
                    type = "uint64";
                otherwise
                    type = "uint32";
            end
