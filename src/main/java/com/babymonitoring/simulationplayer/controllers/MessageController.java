    ...
    public void lobby(Message message) throws Exception {
        Thread newThread = new Thread(() -> {
            try {
                ...
                // double tsp = 0.01;
                // double te = 10;
                // new Simulation(this).startSimulation(t, steps, a, f, ts, tsp, te,
                // message.getUserId());
                // ---------------------------
                ...
                int ncyclemax = 300;
                boolean lamb = false;
                new Simulation(this).startProductionSimulation(mother, uterus, foetus, umbilical, brain, CAVmodel, scen,
                        HES, persen, duty, ncyclemax, lamb, message.getUserId());
                // ---------------------------------
